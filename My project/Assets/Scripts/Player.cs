...
public class Player : MonoBehaviour
{
    ...
    public Animator DashCoolTime_Ani;

    public Spell_Manager spell_Manager;

    void Start()
    {
        DashCoolTime_Ani = transform.Find("DashCoolTime").GetComponent<Animator>();
    ...
    {
        DashCoolTime_Ani.gameObject.SetActive(true);
        DashCoolTime_Ani.SetTrigger("isDash");
        yield return new WaitForSeconds(dashCoolTime);
        isDashCooltime = false;
        DashCoolTime_Ani.gameObject.SetActive(false);
    }
